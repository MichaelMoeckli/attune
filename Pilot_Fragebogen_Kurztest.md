...
**Ziel-Bearbeitungszeit:** 5–7 Minuten · 23 quantitative Items + 2 offene Fragen.
**Erfassung:** Google Forms (oder MS Forms). Ein Formular für beide Formate, eine Pflicht-Frage steuert die Auswertung.

---

## Theoretische Verankerung der Item-Auswahl

Die Items sind nicht willkürlich, sondern entlang der Validierungs-Dreiteilung aus Kap. 8 und der Theorie-Anker aus Kap. 2.3 abgeleitet. Diese Tabelle ist gleichzeitig die Verteidigungs-Grundlage gegenüber dem Dozenten:

| Block | Validierungsstrang (Kap. 8) | Theorie-Anker (Kap. 2.3) | Anzahl Items |
|---|---|---|---|
| 1 Demographie | 8.5.1 / 8.5.2 | — | 4 |
| 2 Usability | 8.3.3 (SUS) | Brooke 1996 / Bangor et al. 2008 | 10 |
| 3 Wirkung | 8.4.1 | SDT, METUX, VSD, Digital Wellbeing, Alg. Souveränität | 5 |
| 4 Kontrollvariablen | 8.4.2 | klassische Mediennutzung | 2 |
| 5 Awareness | 8.4.3 | Reviglio & Agosti 2020 | 2 |
| 6 Offene Fragen | 8.5.3 | qualitative Ergänzung | 2 |

---

## Vorab — eine einzige Steuerungsfrage

> **Welches Studienformat füllst du gerade aus?**
> ◯ Format A — direkt nach der ersten Sendung
> ◯ Format B — nach 1 Woche / mindestens 1 Wochenende Nutzung
> *(Pflichtfeld, dient nur der Auswertung. Wer beide Formate macht, füllt zweimal aus.)*

---

## Block 1 — Demographie & Mediennutzung (4 Items)

**D1. Teilnehmer-Code** *(damit Doppel-Teilnehmende A und B einander zugeordnet werden können — z. B. Initialen + Geburtsjahr, etwa „MM-1996")*
Freitext, kurz.

**D2. Altersgruppe**
◯ unter 25 ◯ 25–34 ◯ 35–49 ◯ 50–64 ◯ 65+

**D3. Höchster Bildungsabschluss**
◯ Obligatorische Schule ◯ Berufslehre / Sek II ◯ Höhere Berufsbildung ◯ FH/Uni Bachelor ◯ FH/Uni Master oder höher

**D4. Wie viele Stunden hörst du an einem typischen Tag Radio, Podcast oder Audio-Streaming?**
◯ unter 30 Min ◯ 30–60 Min ◯ 1–2 Std ◯ 2–4 Std ◯ über 4 Std

---

## Block 2 — Usability (System Usability Scale, 10 Items)

**Anleitung im Formular:** „Bitte gib für die folgenden 10 Aussagen an, wie stark du zustimmst."
**Antwortskala (für alle 10 Items identisch):** 1 = stimme gar nicht zu · 2 · 3 · 4 · 5 = stimme voll zu
...
## Block 4 — Kontrollvariablen Information & Unterhaltung (2 Items)

**Anleitung:** „Unabhängig vom Wellbeing-Anspruch — wie würdest du die Sendung als klassisches Radioformat einschätzen?"
**Antwortskala:** 1 = trifft gar nicht zu · … · 5 = trifft voll zu

K1. Die Sendung war für mich **informativ**.
K2. Die Sendung war für mich **unterhaltsam**.

*Begründung im Kap. 8.4.2: ein wellbeing-orientiertes Radio darf seine Grundfunktion nicht verfehlen.*

---

## Block 5 — Awareness (2 Items)
...
3. **Antwortformat festlegen:**
   ...
   - D1 → *Kurzantwort* (Pflicht).
   - D2, D3, D4 → *Multiple-Choice* (Pflicht).
   - SUS-Items + Wirkung + Kontrollvariablen + Awareness → *Lineare Skala 1–5*, Beschriftung links „stimme gar nicht zu", rechts „stimme voll zu". Alle als Pflicht markieren.
   - O1, O2 → *Absatz*. Optional, nicht Pflicht.
4. **Reihenfolge nicht randomisieren** für SUS (Standard verlangt feste Reihenfolge). Wirkung-Items dürfen randomisiert werden, ist aber für n < 10 nicht nötig.
5. **Antworten-Tab:** auf „Antworten in Tabelle erfassen" stellen → Export als CSV/Excel reicht für Auswertung in Excel.
6. **Probelauf** mit dir selbst und einer weiteren Person, bevor du den Link rausgibst. Stoppuhr mitlaufen lassen — Ziel ≤ 7 Min.

---

## Wiederverwendung für Format B
...
Diese drei Items adressieren genau den im Kap. 8.6.4 angesprochenen Erstkontakt-vs.-Gewohnheits-Effekt und gehören damit zur methodischen Pointe der Studie.

---

## Was du als Nächstes brauchst (nicht Teil des Fragebogens, aber im selben Atemzug zu klären)

- **Einwilligungserklärung (Anhang H, Kap. 8.8)** — separates Dokument, vor dem Test unterschreiben lassen.
- **Onboarding-Skript (Kap. 8.6.2, max. 10 Min)** — was sagst du den Testpersonen vor der ersten Sendung?
- **Interview-Leitfaden (Kap. 8.6.2)** — die 15–20 Min danach. Drei bis fünf offene Leitfragen reichen, sie ergänzen O2.

Wenn du willst, formuliere ich dir Einwilligung, Onboarding-Skript und Leitfaden in einem nächsten Schritt.
